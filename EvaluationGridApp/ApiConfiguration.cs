...
using System;
using EvaluationGridApp.App_Start;
using EvaluationGridApp.Utilities;
using EvaluationGridApp.Configuration;
using EvaluationGridApp.Services;
using EvaluationGridApp.Authentication;
using EvaluationGridApp.Filters;
...
namespace EvaluationGridApp
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "EvaluationGridApp"))
                .EnableSwaggerUi();
